...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <form  action="index.php?act=updatetkshop" class="js-form-submit-data"  method="POST">
        <input type="hidden" name="id" value="<?=$user['id']?>">
        <div class="form-group row mt-5">
            <label for="user_id" class="col-md-2 offset-md-2 col-form-label">Mã thành viên</label>
            <div class="col-md-6">
                <input type="text" readonly class="form-control disable" id="user_id" value="<?php echo $user['id'] ?>">
            </div>
        </div>
        ...
        <div class="form-group row mt-5">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control" id="user_name" name="name" placeholder="Ex: Nguyễn Văn A" value="<?php echo $user['name'] ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="user_email" class="col-md-2 offset-md-2 col-form-label">Email</label>
            <div class="col-md-6">
                <input type="text" class="form-control" id="user_email" name="email"  placeholder="...@gmail.com" value="<?php echo $user['email'] ?>">
            </div>
        </div>
        <div class="form-group row mt-5">
        ...
        <div class="col-md-6">
                <a class="" href="index.php?act=doimatkhau">Đổi mật khẩu</a>
            </div>
        </div>
        <div class="form-group row mt-5">
            <label for="user_email" class="col-md-2 col-form-label"></label>
            <div class="col-md-8">
                <input type="submit" name="capnhat" class="btn btn-primary btn-lg mb-2 btn-block" value="Lưu & Cập nhật">
            </div>
        </div>
