 ...
 <?php
        ...
        if(isset($_SESSION['idbd'])&&($_SESSION['idbd']>0)){
            $b = new baidang();
            $bd = $b->getInfoByIdbaidang($_SESSION['idbd']);
        }
    ?>
...
egrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <form action="index.php?act=updatebd" method="post"class="form-horizontal js-form-submit-data js-frm-manage-post"
                    ...
                    <div class="row mt-3">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="province_id" name="tinh" class="form-control js-select-tinhthanhpho" value="<?php echo $bd['tinh'] ?>">
                        ...
                        <div class="col-md-3">
                            ...
                            <input id="district_id" class="form-control js-select-quanhuyen" type="text" name="huyen" value="<?php echo $bd['huyen'] ?>">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="col-form-label" for="phuongxa">Phường/Xã</label>
                                    <input  class="form-control js-select-phuongxa" type="text" name="xa"  value="<?php echo $bd['xa'] ?>">
                                    </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control js-input-street-number" name="sonha"
                                    id="street_number" value="<?php echo $bd['sonha'] ?>">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text"  class="form-control" name="adress" id="diachi"value="<?php echo $bd['adress'] ?>" >
                            </div>
                        </div>
                    </div>
  ...
  ?> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <input type="text" class="form-control js-title" name="tieude" id="post_title" value="<?php echo $bd['tieude'] ?>"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <textarea class="form-control js-content" name="noidung" id="post_content" value="<?php echo $bd['noidung'] ?>" rows="10"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                                <input id="ten_lien_he" type="text" name="tennd" class="form-control" value="<?php echo $bd['tennd'] ?>"
                                   >
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                                <input id="phone" type="number" name="lienhe" class="form-control"value="<?php echo $bd['lienhe'] ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                <input id="giachothue" name="giathue" pattern="[0-9.]+" type="text" class="form-control" value="<?php echo $bd['giathue'] ?>"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                                <input id="post_acreage" type="number" attern="[0-9.]+" name="dientich" value="<?php echo $bd['dientich'] ?>" max="1000"
                    ...
                    <div class="form-group row mt-5">
                        <div class="col-md-12">
                            <input type="submit" value="Update" class="btn btn-success mb-5 btn-lg btn-block js-btn-hoan-tat" name="update">
                ...
                <div class="table-responsive">
                    <table class="table table_post_listing table-bordered _table-hover">
                       ...
                       <tr>
                          ...
                          <a href="index.php?act=updatebd&id='.$bd['id'].'">Sửa</a></td>
                       </tr>
                   </tbody>' ;
                        ?>
                    </table>
